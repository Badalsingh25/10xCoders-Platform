            ...
            {(view === 'login' || (view === 'signup' && step === 'details')) && (
              <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-3 gap-3">
                  <button type="button" className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 bg-gradient-to-r hover:from-red-50 hover:to-white transition-all" onClick={() => window.location.href = `${API_URL}/api/auth/google`}>
                  ...
                  <button type="button" className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 bg-gradient-to-r hover:from-gray-50 hover:to-white transition-all" onClick={() => window.location.href = `${API_URL}/api/auth/github`}>
                  ...
                  <button type="button" className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 bg-gradient-to-r hover:from-blue-50 hover:to-white transition-all" onClick={() => window.location.href = `${API_URL}/api/auth/linkedin`}>
